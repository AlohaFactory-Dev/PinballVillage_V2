...
namespace Aloha.Coconut
{
    public class SystemUI : MonoBehaviour
    {
        ...
        public static void ShowNotEnoughGoldToastMessage()
        {
            ShowToastMessage(TextTableV2.Get("SystemUI/ToastMessage/NotEnough", new TextTableV2.Param("property", "<sprite name=Gold>골드")));
        }
